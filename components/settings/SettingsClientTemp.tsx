...
<button className="bg-primary-container text-on-primary-container px-md py-sm rounded-lg font-semibold hover:opacity-90 transition-opacity" style="box-shadow: inset 0 1px 0 rgba(255,255,255,0.2);">Save Changes</button>
</div>
</header>
...
<input className="w-full bg-surface-container-low border border-white/5 rounded-lg px-md py-sm text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" type="text" value="Keystone"/ />
</div>
<div className="flex flex-col gap-xs">
<label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">Last Name</label>
<input className="w-full bg-surface-container-low border border-white/5 rounded-lg px-md py-sm text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" type="text" value="Admin"/ />
</div>
...
<input className="w-full bg-surface-container-low border border-white/5 rounded-lg px-md py-sm text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" type="email" value="admin@keystoneos.dev"/ />
</div>
<div className="flex flex-col gap-xs md:col-span-2">
<label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">Bio</label>
<textarea className="w-full bg-surface-container-low border border-white/5 rounded-lg px-md py-sm text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all resize-none" rows="3">Enterprise system administrator overseeing global deployments.</textarea>
</div>
</div>
</section>
...
<input checked="" className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer transition-transform duration-200 ease-in-out z-10 translate-x-6 border-primary-container" id="toggle1" name="toggle" type="checkbox"/ />
